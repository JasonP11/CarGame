...
export function createVehicleAt(scene, world, x, y, z, gltfLoader, wheelGLBUrl = 'https://raw.githubusercontent.com/JackAlt3/CarGame/main/wheels.glb') {
    // Create a box-like chassis for the plane (like a car body but as wireframe)
    const geometry = new THREE.BoxGeometry(20, 15, 0.1); // length like car body
    const material = new THREE.MeshBasicMaterial({
        color: 0xff0000,
        wireframe: true
    });
    const chassisBody = new THREE.Mesh(geometry, material);
    chassisBody.position.set(109, 7.5, -109);
